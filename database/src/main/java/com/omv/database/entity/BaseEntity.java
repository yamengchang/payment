package com.omv.database.entity;


import com.omv.common.util.basic.IDUtil;
import com.omv.common.util.error.CustomException;
import com.omv.database.bean.VerifyBean;
import com.omv.database.bean.VerifyBiz;
import com.omv.database.bean.VerifyType;
import com.omv.database.error.BaseRecordError;
