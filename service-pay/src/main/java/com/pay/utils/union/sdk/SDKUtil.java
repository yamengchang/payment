...
import static com.pay.utils.union.sdk.SDKConstants.*;
...
public class SDKUtil {
    public static boolean sign(Map<String, String> data, String base64Cert, String certPwd, String encoding) {
        try {
            if (isEmpty(encoding)) {
                encoding = "UTF-8";
            }
            KeyStore keyStore = CertUtil.getKeyInfoByBase64File(base64Cert,
...
//			}
    ...
    public static boolean validateSign(Map<String, String> rspData, String middleCert,String rootCert, String encoding) {
...
//				LogUtil.writeLog("验签公钥证书：["+strCert+"]");
        ...
        // 2.验证证书链
        if (!CertUtil.verifyCertificateWithPubKeyFile(x509Cert,middleCert,rootCert)) {
            LogUtil.writeErrorLog("验证公钥证书失败，证书信息：[" + strCert + "]");
            return false;
        }
