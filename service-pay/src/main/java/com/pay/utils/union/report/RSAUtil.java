...
public class RSAUtil {
    ...
    public static String getKey(String acqPubKey) throws Exception {
        String content = acqPubKey;
    ...
    public static boolean verifyByKeyPath(String content, String sign, String acqPubKey, String input_charset) {
        try {
            return verify(content, sign, getKey(acqPubKey), input_charset);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
