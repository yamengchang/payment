package com.omv.common.util.httpclient.bean;


import com.omv.common.util.httpclient.biz.HttpMethod;
...
public class HttpBean {
    ...
    private Map<String, InputStream> streamfiles;
    ...
    public void addParameters(Map<String, Object> reqMap) {
    ...
    public void addFile(String key, InputStream inputStream) {
        ...
        this.streamfiles.put(key, inputStream);
    }
