...
public abstract class PoiExcelHelper {
     ...
     * 获取sheet列表，子类必须实现
     */
    public abstract ArrayList<String> getSheetList(InputStream inStream);

    /**
     * 读取Excel文件数据
     */
    public ArrayList<ArrayList<String>> readExcel(InputStream inStream, int sheetIndex) {
        return readExcel(inStream, sheetIndex, "1-", "1-");
    }

    /**
     * 读取Excel文件数据
     */
    public ArrayList<ArrayList<String>> readExcel(InputStream inStream, int sheetIndex, String rows) {
        return readExcel(inStream, sheetIndex, rows, "1-");
    }

    /**
     * 读取Excel文件数据
     */
    public ArrayList<ArrayList<String>> readExcel(InputStream inStream, int sheetIndex, String[] columns) {
        return readExcel(inStream, sheetIndex, "1-", columns);
    }

    /**
     * 读取Excel文件数据，子类必须实现
     */
    public abstract ArrayList<ArrayList<String>> readExcel(InputStream inStream, int sheetIndex, String rows, String columns);
    ...
    public ArrayList<ArrayList<String>> readExcel(InputStream inStream, int sheetIndex, String rows, String[] columns) {
        ...
        return readExcel(inStream, sheetIndex, rows, cols);
    }

    /**
     * 读取Excel文件数据，子类必须实现
     */
    public abstract ArrayList<ArrayList<String>> readExcel(InputStream inStream, int sheetIndex, String rows, int[] cols);
