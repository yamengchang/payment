...
public interface RedisClient {
    ...
    *@Date: 2018/8/9 17:23
    *@Description : 分布式锁
    *@Params :  @Params lockKey - 锁的唯一标识
    *          @Params requestId - 加锁人的唯一标识（用于只有该用户才能解锁）
    *          @Params expireTime - 锁的时间
    */
    Boolean distributedLock(String lockKey, String requestId, int expireTime);
